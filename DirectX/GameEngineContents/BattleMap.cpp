...
void BattleMap::SetTerrainData_Stage4()
{
	...
	TerrainData[6] = { Terrain::Forest, Terrain::Plain, Terrain::Plain, Terrain::Wall, Terrain::Floor, Terrain::Floor, Terrain::Floor, Terrain::Floor, Terrain::Floor, Terrain::Floor, Terrain::Floor, Terrain::Wall, Terrain::Plain, Terrain::Plain, Terrain::Plain };
...
void BattleMap::SetTerrainData_Stage8()
{
	...
	TerrainData[12] = { Terrain::Cliff, Terrain::Cliff, Terrain::Plain, Terrain::Forest, Terrain::Plain, Terrain::Cliff, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain, Terrain::Plain };
